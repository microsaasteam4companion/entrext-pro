...
const Mechanisms = () => {
    ...
    useEffect(() => {
        ...
        const interval = setInterval(() => {
            if (iterations >= maxIterations) {
                ...
                setOwnedPercentage(100);
            } else {
                setOwnedPercentage(Math.floor((iterations / maxIterations) * 100));
                iterations++;
            }
        }, 50);
    ...
    const circleOffset = circleCircumference - (circleCircumference * ownedPercentage) / 100;
                ...
                <div className="grid md:grid-cols-2 gap-6 md:gap-8 mb-6 md:mb-8">
                    <div className="glass-card p-8 md:p-12 rounded-3xl flex flex-col justify-center reveal active hover:border-tertiary/30 transition-colors glow-hover">
                        ...
                        <h2 className="font-headline text-4xl lg:text-7xl font-medium tracking-tight leading-tight text-white">
                            <span className="inline-block min-w-[140px] lg:min-w-[240px]"><SplitFlap text={targetNumber} length={5} color="white" /></span> Founders Screened, <br/>
                    ...
                    <div className="glass-card p-8 md:p-12 rounded-3xl reveal active hover:border-tertiary/30 transition-colors glow-hover">
                        ...
                        <div className="grid grid-cols-2 gap-3 md:gap-4">
                            <div className="bg-surface-container p-4 md:p-6 rounded-2xl border border-outline-variant/10 hover:-translate-y-2 hover:shadow-lg hover:shadow-tertiary/10 hover:border-tertiary/30 transition-all duration-300 cursor-default">
                    ...
                    <div className="md:col-span-4 bg-white p-8 md:p-12 rounded-3xl flex flex-col items-center justify-center text-center reveal active card-float hover:scale-105 hover:shadow-2xl transition-all duration-500 hover:-translate-y-4">
                        ...
                        <div className="relative w-32 h-32 md:w-48 md:h-48 mb-8 md:mb-12 flex items-center justify-center">
                            <svg className="w-full h-full -rotate-90" viewBox="0 0 192 192">
                                ...
                                <circle className="circle-progress transition-all duration-75 ease-linear" cx="96" cy="96" fill="transparent" r="88" stroke="#232323" strokeDasharray={circleCircumference} strokeDashoffset={circleOffset} strokeWidth="8" strokeLinecap="round"></circle>
                            </svg>
                            <div className="absolute inset-0 flex flex-col items-center justify-center">
                                ...
                                <span className="text-black font-headline text-3xl md:text-5xl font-black">{ownedPercentage}%</span>
                            </div>
                        </div>
